    ...
    <div className="flex flex-wrap md:text-left text-center order-first">
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
        ...
        <nav className="list-none mb-10">
          ...
          <li>
            <a className="text-black-900 hover:text-gray-800"><FontAwesomeIcon icon="fa-solid fa-location-dot" /> Sapphire Retail Head Office
            1.5-Km, Defence Road, Bhobtian Chowk, Off Raiwind Road, Opposite University of Lahore, Lahore.</a>
          </li>
          <li>
            <a className="text-black-900 hover:text-gray-800"><FontAwesomeIcon icon="fa-solid fa-envelope" /> wecare@sapphireonline.pk</a>
          </li>
          <li>
            <a className="text-black-900 hover:text-gray-800"><FontAwesomeIcon icon="fa-solid fa-phone" /> +92(0)42 111-738-245</a>
          </li>
        </nav>
      </div>
      <div className="lg:w-1/4 md:w-1/2 w-full px-4">
